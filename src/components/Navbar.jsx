...
function Navbar() {
    return (
        ...
        <div className='fixed top-0 left-0 right-0 z-50 w-full flex justify-between p-4 py-5 px-14 bg-[#08090b]/80 backdrop-blur-lg border-b border-white/5 text-white'>
            <h2 className='items-center flex'>Trail</h2>
            <div className='flex gap-9  font-medium items-center'>
                <ProfileDropdown/>
                <div className='relative flex '>
                <input className='w-full py-2 px-3 pl-3 pr-8 rounded-lg bg-[#272c37]/40  flex items-center focus:outline-none  transition' placeholder='Search' type='text'  />
